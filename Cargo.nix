...
rec {
  ...
  workspaceMembers = {
    "kagemusha-analyzer" = rec {
      packageId = "kagemusha-analyzer";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kagemusha-analyzer" = rec {
        crateName = "kagemusha-analyzer";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagemusha-analyzer; };
        libName = "kagemusha_analyzer";
        dependencies = [
          {
            name = "async-trait";
            packageId = "async-trait";
        ...
        resolvedDefaultFeatures = [ "persistence" "tor" ];
      };
      "kagemusha-cli" = rec {
        crateName = "kagemusha-cli";
        version = "0.1.0";
        edition = "2024";
        crateBin = [
          {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagemusha-cli; };
        dependencies = [
          {
            name = "clap";
            packageId = "clap";
      ...
      "kagemusha-core" = rec {
        crateName = "kagemusha-core";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagemusha-core; };
        libName = "kagemusha_core";
        dependencies = [
          {
            name = "async-trait";
            packageId = "async-trait";
